...
AS
	...
	SELECT    ssbid.SSB_CRMSYSTEM_CONTACT_ID
              ...
              , CAST(CASE WHEN dimcustomer.EmailPrimary IS NOT NULL
                          AND dimcustomer.EmailPrimary LIKE '%@%' THEN 1
                     ELSE 0
                END AS Bit) Primary_Email_Exists
              ...
              , CAST(CASE WHEN dimcustomer.EmailOne IS NOT NULL
                          AND dimcustomer.EmailOne LIKE '%@%' THEN 1
                     ELSE 0
                END AS Bit) Email_One_Exists
              ...
              , CAST(CASE WHEN dimcustomer.EmailTwo IS NOT NULL
                          AND dimcustomer.EmailTwo LIKE '%@%' THEN 1
                     ELSE 0
                END AS Bit) Email_Two_Exists
              ...
              , dimcustomer.Birthday AS Birthday
