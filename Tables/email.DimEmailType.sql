...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__1C270AE2] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__1D1B2F1B] DEFAULT (getdate()),
