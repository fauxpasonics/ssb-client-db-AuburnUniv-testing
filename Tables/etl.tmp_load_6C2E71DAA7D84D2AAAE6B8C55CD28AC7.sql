CREATE TABLE [etl].[tmp_load_6C2E71DAA7D84D2AAAE6B8C55CD28AC7]
(
...
[CustomerType] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CustomerStatus] [nvarchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[FullName] [nvarchar] (306) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[customer_matchkey] [nvarchar] (109) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6C2E71DAA7D84D2AAAE6B8C55CD28AC7_ss] ON [etl].[tmp_load_6C2E71DAA7D84D2AAAE6B8C55CD28AC7] ([SourceSystem], [SSID])
GO
