CREATE TABLE [etl].[tmp_load_671B1904193C4D3088CE433FDC60C4E8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_671B1904193C4D3088CE433FDC60C4E8_ss] ON [etl].[tmp_load_671B1904193C4D3088CE433FDC60C4E8] ([SourceSystem], [SSID])
GO
