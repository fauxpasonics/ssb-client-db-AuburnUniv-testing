CREATE TABLE [mdm].[tmp_MDM_Custom_Rules]
(
...
GO
CREATE CLUSTERED INDEX [ix_MDM_Custom_Rules] ON [mdm].[tmp_MDM_Custom_Rules] ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_Composite_01] ON [mdm].[tmp_MDM_Custom_Rules] ([DimCustomerId]) INCLUDE ([QTY], [SH], [TRANS])
GO
