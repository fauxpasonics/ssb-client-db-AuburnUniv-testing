...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Adobe_Rec__ETL_C__4B26F34E] DEFAULT (getdate()),
...
GO
ALTER TABLE [stg].[Adobe_Recipient] ADD CONSTRAINT [PK__Adobe_Re__A2D9E5649B8A8343] PRIMARY KEY CLUSTERED  ([PrimaryKey])
GO
