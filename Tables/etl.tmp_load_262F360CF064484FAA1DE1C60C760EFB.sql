CREATE TABLE [etl].[tmp_load_262F360CF064484FAA1DE1C60C760EFB]
(
...
[SSCreatedDate] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SSUpdatedDate] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[AccountId] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[IsBusiness] [int] NOT NULL,
[IsDeleted] [bit] NOT NULL,
[customer_matchkey] [varchar] (59) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_262F360CF064484FAA1DE1C60C760EFB_ss] ON [etl].[tmp_load_262F360CF064484FAA1DE1C60C760EFB] ([SourceSystem], [SSID])
GO
